(function () {
  ...
  nav.innerHTML = `
    ...
    <div id="_nav-pnl">
      <div class="_pnl-row"><span class="_pnl-label">TZ Live</span><span class="_pnl-val _pnl-zero" id="_pnl-cash">—</span></div>
    </div>
  `;
  ...
  fetch('account_balance.json')
    ...
    .then(d => {
      if (!d) return;
      _fmtBalance(document.getElementById('_pnl-cash'), d.balance);
    })
    .catch(() => {});
})();
